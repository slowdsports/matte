                ...
                <div class="embed-responsive embed-responsive-16by9 hidden" id="playerContainer">
                    ...
                    if (isset($_GET['ifr']) || isset($_GET['evento'])) {
                        ...
                        if (strpos($canalUrl, "claro") || strpos($canalUrl, "cvatt")) {
                            $src = "id='embed-player' class='embed-responsive-item' width='100%' height='100%' frameborder='0' scrolling='no' allowfullscreen allow='encrypted-media' src='https://clarovideo.megatelevisiontv.live/vader?c=$canalAlt'";
                        } // Configurar los IZZI
